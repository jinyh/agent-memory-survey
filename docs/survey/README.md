...
- [01-framework.md](./01-framework.md)：统一框架，解释为什么生命周期主线比静态记忆分类更有效。
...
- 如果你在追问“memory 为什么不等于检索”，从 [01-framework.md](./01-framework.md) 开始，再读 [04-retrieval.md](./04-retrieval.md) 和 [05-evaluation.md](./05-evaluation.md)。
...
- `RLM / MSA`：优先看 [01-framework.md](./01-framework.md)、[04-retrieval.md](./04-retrieval.md)、[06-systems-and-engineering.md](./06-systems-and-engineering.md)。
...
每章开头现在都补了一个“研究矩阵”。它不是摘要版目录，而是把该章争论压到同一比较口径下：
